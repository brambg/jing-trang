...
public class CompactSyntax<Pattern, NameClass, Location, ElementAnnotation,
  ...
  final public Pattern Input(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException {Pattern p;
    Preamble();
...
{if ("" != null) return p;}
  ...
  final public Pattern IncludedGrammar(IncludedGrammar<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> g) throws ParseException {AnnotationsImpl a;
  Pattern p;
    Preamble();
...
{if ("" != null) return p;}
  ...
  final public Pattern TopLevelGrammar(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException {AnnotationsImpl a = getTopLevelCommentsAsAnnotations();
...
namespaceMap.put("xml", WellKnownNamespaces.XML);
  ...
  final public void NamespaceDecl() throws ParseException {LocatedString prefix = null;
...
if (isDefault)
  ...
  final public String NamespaceName() throws ParseException {String r;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LITERAL:{
      r = Literal();
      break;
...
{if ("" != null) return r;}
  ...
  final public void DatatypesDecl() throws ParseException {LocatedString prefix;
  String uri;
noteTopLevelComments();
    jj_consume_token(16);
    prefix = UnprefixedName();
...
datatypesMap.put(prefix.getString(), uri);
  ...
  final public Pattern AnnotatedPrimaryExpr(boolean topLevel, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, Token[] except) throws ParseException {AnnotationsImpl a;
  Pattern p;
  ElementAnnotation e;
  Token t;
    a = AnnotationsImpl();
...
{if ("" != null) return p;}
  ...
  final public Pattern PrimaryExpr(boolean topLevel, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a, Token[] except) throws ParseException {Pattern p;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 26:{
...
{if ("" != null) return p;}
  ...
  final public Pattern EmptyExpr(AnnotationsImpl a) throws ParseException {Token t;
    t = jj_consume_token(17);
{if ("" != null) return sb.makeEmpty(makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern TextExpr(AnnotationsImpl a) throws ParseException {Token t;
    t = jj_consume_token(18);
{if ("" != null) return sb.makeText(makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern NotAllowedExpr(AnnotationsImpl a) throws ParseException {Token t;
    t = jj_consume_token(19);
{if ("" != null) return sb.makeNotAllowed(makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern Expr(boolean topLevel, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, Token t, AnnotationsImpl a) throws ParseException {Pattern p;
...
if (patterns.size() == 1 && a != null) {
  ...
  final public Pattern UnaryExpr(boolean topLevel, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, boolean[] hadOccur, Token[] except) throws ParseException {Pattern p;
  Token t;
  ElementAnnotation e;
...
{if ("" != null) return p;}
  ...
  final public Pattern ElementExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  NameClass nc;
  Pattern p;
...
p = afterPatternComments(p);
    jj_consume_token(12);
{if ("" != null) return sb.makeElement(nc, p, makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern AttributeExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  NameClass nc;
  Pattern p;
...
p = afterPatternComments(p);
    jj_consume_token(12);
{if ("" != null) return sb.makeAttribute(nc, p, makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public NameClass NameClass(int context, Ref<AnnotationsImpl> ra) throws ParseException {AnnotationsImpl a;
  NameClass nc;
    a = AnnotationsImpl();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 5:
...
{if ("" != null) return nc;}
  ...
  final public NameClass AnnotateAfter(NameClass nc) throws ParseException {ElementAnnotation e;
    label_10:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case FANNOTATE:{
...
{if ("" != null) return nc;}
  ...
  final public NameClass NameClassAlternatives(int context, NameClass nc, Ref<AnnotationsImpl> ra) throws ParseException {Token t;
...
{if ("" != null) return nc;}
  ...
  final public NameClass BasicNameClass(int context) throws ParseException {AnnotationsImpl a;
  NameClass nc;
    a = AnnotationsImpl();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 5:
...
{if ("" != null) return nc;}
  ...
  final public NameClass PrimaryNameClass(int context, AnnotationsImpl a) throws ParseException {NameClass nc;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 5:
    case 6:
    case 7:
...
{if ("" != null) return nc;}
  ...
  final public NameClass OpenNameClass(int context, AnnotationsImpl a) throws ParseException {Token t;
  LocatedString ns;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PREFIX_STAR:{
      ns = NsName();
checkNsName(context, ns); {if ("" != null) return sb.makeNsName(ns.getString(), ns.getLocation(), a);}
      break;
      }
    case 25:{
      t = jj_consume_token(25);
checkAnyName(context, t); {if ("" != null) return sb.makeAnyName(makeLocation(t), a);}
      break;
      }
    default:
      jj_la1[34] = jj_gen;
  ...
  final public NameClass UnprefixedNameClass(int context, AnnotationsImpl a) throws ParseException {LocatedString name;
    name = UnprefixedName();
String ns;
    if ((context & (IN_ATTRIBUTE|IN_ELEMENT)) == IN_ATTRIBUTE)
      ...
      ns = defaultNamespace;
    {if ("" != null) return sb.makeName(ns, name.getString(), null, name.getLocation(), a);}
    throw new Error("Missing return statement in function");
  }

  final public NameClass PrefixedNameClass(AnnotationsImpl a) throws ParseException {Token t;
    t = jj_consume_token(PREFIXED_NAME);
String qn = t.image;
    int colon = qn.indexOf(':');
    String prefix = qn.substring(0, colon);
    {if ("" != null) return sb.makeName(lookupPrefix(prefix, t), qn.substring(colon + 1), prefix, makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public NameClass NsNameExceptClass(int context, AnnotationsImpl a, Ref<AnnotationsImpl> ra) throws ParseException {LocatedString ns;
  NameClass nc;
    ns = NsName();
...
{if ("" != null) return nc;}
  ...
  final public LocatedString NsName() throws ParseException {Token t;
    t = jj_consume_token(PREFIX_STAR);
String qn = t.image;
    String prefix = qn.substring(0, qn.length() - 2);
    {if ("" != null) return new LocatedString(lookupPrefix(prefix, t), t);}
    throw new Error("Missing return statement in function");
  }

  final public NameClass AnyNameExceptClass(int context, AnnotationsImpl a, Ref<AnnotationsImpl> ra) throws ParseException {Token t;
  NameClass nc;
    t = jj_consume_token(25);
...
{if ("" != null) return nc;}
  ...
  final public NameClass ParenNameClass(int context, AnnotationsImpl a) throws ParseException {Token t;
  NameClass nc;
...
if (ra.get() != null)
  ...
  final public NameClass ExceptNameClass(int context) throws ParseException {NameClass nc;
    jj_consume_token(30);
    nc = BasicNameClass(context);
{if ("" != null) return nc;}
    throw new Error("Missing return statement in function");
  ...
  final public Pattern ListExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  Pattern p;
...
p = afterPatternComments(p);
    jj_consume_token(12);
{if ("" != null) return sb.makeList(p, makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern MixedExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  Pattern p;
...
p = afterPatternComments(p);
    jj_consume_token(12);
{if ("" != null) return sb.makeMixed(p, makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern GrammarExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  Grammar<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> g;
...
topLevelComments(g);
    jj_consume_token(12);
{if ("" != null) return g.endGrammar(makeLocation(t), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern ParenExpr(boolean topLevel, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  Pattern p;
    t = jj_consume_token(28);
...
{if ("" != null) return p;}
  ...
  final public AnnotationsImpl GrammarBody(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {ElementAnnotation e;
    label_12:
    while (true) {
      if (jj_2_3(2)) {
        ;
...
{if ("" != null) return a;}
  ...
  final public void GrammarComponent(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException {ElementAnnotation e;
  AnnotationsImpl a;
    a = AnnotationsImpl();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 5:
...
section.topLevelAnnotation(e);
  ...
  final public void Start(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
...
section.define(GrammarSection.START, combine, p, makeLocation(t), a);
  ...
  final public void Define(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {LocatedString name;
  GrammarSection.Combine combine;
  Pattern p;
    name = Identifier();
    combine = AssignOp();
...
{if ("" != null) return null;}
    ...
    case 4:{
      jj_consume_token(4);
{if ("" != null) return GrammarSection.COMBINE_CHOICE;}
      break;
      }
    case 3:{
      jj_consume_token(3);
{if ("" != null) return GrammarSection.COMBINE_INTERLEAVE;}
      break;
      }
    default:
      jj_la1[40] = jj_gen;
  ...
  final public void Include(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  String href;
  String ns;
...
try {
  ...
  final public AnnotationsImpl IncludeBody(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {ElementAnnotation e;
    label_15:
    while (true) {
      if (jj_2_5(2)) {
        ;
...
{if ("" != null) return a;}
  ...
  final public void IncludeComponent(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException {ElementAnnotation e;
  AnnotationsImpl a;
    a = AnnotationsImpl();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 5:
...
section.topLevelAnnotation(e);
  ...
  final public void Div(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
...
div.endDiv(makeLocation(t), a);
  ...
  final public void IncludeDiv(GrammarSection<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  Div<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> div = section.makeDiv();
    t = jj_consume_token(6);
    jj_consume_token(11);
...
div.endDiv(makeLocation(t), a);
  ...
  final public Pattern ExternalRefExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {Token t;
  String href;
  String ns;
    ...
    ns = Inherit();
try {
      {if ("" != null) return sb.makeExternalRef(href, sourceUri, ns, scope, makeLocation(t), a);}
    }
    catch (IllegalSchemaException e) {
      {if ("" != null) return sb.makeErrorPattern();}
    }
    throw new Error("Missing return statement in function");
  }

  final public String Inherit() throws ParseException {String ns = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 15:{
      jj_consume_token(15);
      jj_consume_token(2);
...
if (ns == null)
  ...
  final public Pattern ParentExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {LocatedString name;
    jj_consume_token(34);
a = addCommentsToChildAnnotations(a);
    name = Identifier();
{if ("" != null) return scope.makeParentRef(name.getString(), name.getLocation(), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern IdentifierExpr(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a) throws ParseException {LocatedString name;
    name = Identifier();
{if ("" != null) return scope.makeRef(name.getString(), name.getLocation(), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern ValueExpr(boolean topLevel, AnnotationsImpl a) throws ParseException {LocatedString s;
    s = LocatedLiteral();
if (topLevel && annotationsIncludeElements) {
      error("top_level_follow_annotation", s.getToken());
      a = null;
    }
    {if ("" != null) return sb.makeValue("", "token", s.getString(), getContext(), defaultNamespace, s.getLocation(), a);}
    throw new Error("Missing return statement in function");
  }

  final public Pattern DataExpr(boolean topLevel, Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, AnnotationsImpl a, Token[] except) throws ParseException {Token datatypeToken;
  Location loc;
  String datatype;
...
if (topLevel && annotationsIncludeElements) {
      ...
      {if ("" != null) return sb.makeValue(datatypeUri, datatype, s, getContext(), defaultNamespace, loc, a);}
      break;
      }
    default:
      jj_la1[48] = jj_gen;
...
{if ("" != null) return e == null ? dpb.makePattern(loc, a) : dpb.makePattern(e, loc, a);}
    }
    throw new Error("Missing return statement in function");
  }

  final public Token DatatypeName() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 35:{
...
{if ("" != null) return t;}
  ...
  final public LocatedString Identifier() throws ParseException {LocatedString s;
  Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
...
{if ("" != null) return s;}
  ...
  final public String Prefix() throws ParseException {Token t;
  String prefix;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
      t = jj_consume_token(IDENTIFIER);
...
{if ("" != null) return lookupPrefix(prefix, t);}
    throw new Error("Missing return statement in function");
  }

  final public LocatedString UnprefixedName() throws ParseException {LocatedString s;
  Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:
    case ESCAPED_IDENTIFIER:{
...
{if ("" != null) return s;}
  ...
  final public void Param(DataPatternBuilder<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> dpb) throws ParseException {LocatedString name;
  AnnotationsImpl a;
  String value;
    a = AnnotationsImpl();
    name = UnprefixedName();
...
dpb.addParam(name.getString(), value, getContext(), defaultNamespace, name.getLocation(), a);
  ...
  final public Pattern Except(Scope<Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope, Token[] except) throws ParseException {AnnotationsImpl a;
  Pattern p;
  Token t;
...
checkExcept(innerExcept);
  ...
  final public ElementAnnotation Documentation() throws ParseException {CommentListImpl comments = getComments();
...
{if ("" != null) return eab.makeElementAnnotation();}
    throw new Error("Missing return statement in function");
  }

  final public AnnotationsImpl AnnotationsImpl() throws ParseException {CommentListImpl comments = getComments();
...
if (a == null && comments != null)
  ...
  final public void PrefixedAnnotationAttribute(Annotations<Location, ElementAnnotation, CommentListImpl> a, boolean nested) throws ParseException {Token t;
  String value;
    t = jj_consume_token(PREFIXED_NAME);
    jj_consume_token(2);
    value = Literal();
String qn = t.image;
  ...
  final public void UnprefixedAnnotationAttribute(Annotations<Location, ElementAnnotation, CommentListImpl> a) throws ParseException {LocatedString name;
  String value;
    name = UnprefixedName();
    jj_consume_token(2);
    value = Literal();
if (name.getString().equals("xmlns"))
  ...
  final public ElementAnnotation AnnotationElement(boolean nested) throws ParseException {ElementAnnotation a;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PREFIXED_NAME:{
...
{if ("" != null) return a;}
  ...
  final public ElementAnnotation AnnotationElementNotKeyword() throws ParseException {ElementAnnotation a;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PREFIXED_NAME:{
...
{if ("" != null) return a;}
  ...
  final public ElementAnnotation PrefixedAnnotationElement(boolean nested) throws ParseException {CommentListImpl comments = getComments();
  Token t;
  ElementAnnotationBuilder<Location, ElementAnnotation, CommentListImpl> eab;
    t = jj_consume_token(PREFIXED_NAME);
String qn = t.image;
...
{if ("" != null) return eab.makeElementAnnotation();}
  ...
  final public ElementAnnotation UnprefixedAnnotationElement() throws ParseException {CommentListImpl comments = getComments();
  LocatedString name;
  ElementAnnotationBuilder<Location, ElementAnnotation, CommentListImpl> eab;
    name = UnprefixedName();
...
{if ("" != null) return eab.makeElementAnnotation();}
  ...
  final public ElementAnnotation IdentifierAnnotationElement() throws ParseException {CommentListImpl comments = getComments();
  LocatedString name;
  ElementAnnotationBuilder<Location, ElementAnnotation, CommentListImpl> eab;
    name = Identifier();
eab = sb.makeElementAnnotationBuilder("", name.getString(), null,
...
{if ("" != null) return eab.makeElementAnnotation();}
  ...
  final public void AnnotationElementContent(ElementAnnotationBuilder<Location, ElementAnnotation, CommentListImpl> eab) throws ParseException {ElementAnnotation e;
    jj_consume_token(1);
clearAttributeList();
    label_23:
    while (true) {
...
eab.addComment(getComments());
  ...
  final public void AnnotationElementLiteral(ElementAnnotationBuilder<Location, ElementAnnotation, CommentListImpl> eab) throws ParseException {Token t;
  CommentListImpl comments = getComments();
...
{if ("" != null) return s;}
  ...
  final public LocatedString LocatedLiteral() throws ParseException {Token t;
  Token t2;
  String s;
  StringBuffer buf;
    t = jj_consume_token(LITERAL);
...
{if ("" != null) return new LocatedString(s, t);}
    throw new Error("Missing return statement in function");
  }
